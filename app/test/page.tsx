      ...
      <Card className="w-full">
        <CardHeader className="pb-0 pt-1 px-2 modern-header">
          <div className="flex items-center justify-between">
            {/* Smaller Question text and progress */}
            <CardTitle className="flex items-center justify-between text-sm"> 
              <span className="gradient-text text-xs"> {/* Reduced font size */}
            ...
            {/* Smaller question navigation buttons */}
              ...
              {testSequence.map((_, index) => (
                <Button
                  ...
                  className={cn(
                    ...
                    "h-6 min-w-6 px-0.5 text-[10px] leading-none", // Smaller height, width, and font
                  )}
