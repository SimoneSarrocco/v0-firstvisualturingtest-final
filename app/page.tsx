...
export default function Home() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 flex items-center justify-center py-10 px-4">
      <div className="max-w-4xl w-full">
        <div className="text-center mb-8">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 mb-4">
            Visual Turing Test
          </h1>
          <p className="text-xl sm:text-2xl text-gray-700">Vitreous OCT Image Enhancement Evaluation</p>
        </div>
